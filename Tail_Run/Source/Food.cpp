...
void Food(int *hungryTime, bool *deathFlag, int map[20][30], int leftMapnumX, int rightMapnumX, int upMapnumY, int downMapnumY, const int &stageNo, int soundHandle)
{
	bool hit = FALSE;
